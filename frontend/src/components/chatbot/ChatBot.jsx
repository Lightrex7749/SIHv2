  ...
  useEffect(() => {
    ...
    if (storedSessionId) {
      ...
      setMessages([{
        id: 'welcome',
        message: '',
        response: '👋 Hello! I\'m DrishtiSetu, your disaster relocation & management assistant. I can help you with:\n\n- **Real-time disaster alerts** and weather updates\n- **Emergency preparedness** tips and checklists\n- **Safety guidelines** for landslides, floods, earthquakes, and more\n- **Carrying capacity** and relocation intelligence\n- **Evacuation** routes and shelter locations\n\nFeel free to ask me anything about disaster safety and relocation!',
  ...
  const loadChatHistory = async (sessionId) => {
    try {
      ...
      setMessages([{
        id: 'welcome',
        message: '',
        response: '👋 Hello! I\'m DrishtiSetu, your disaster relocation & management assistant. Ask about weather, alerts, safety tips, and relocation readiness.',
        timestamp: new Date().toISOString(),
        isUser: false
      }]);
    } catch (error) {
            ...
            <Card className="flex flex-col h-full shadow-2xl border-2">
              ...
              <div className="flex items-center justify-between p-4 border-b bg-primary text-primary-foreground rounded-t-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg" data-testid="chatbot-title">DrishtiSetu</h3>
              ...
              <ScrollArea ref={scrollViewportRef} className="flex-1 p-4">
                {messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-2">Welcome to DrishtiSetu! 🛡️</h4>
